...
export class n012 extends NPC {
    ...
    stages = {
        0: {
            ...
            dialogues: ["Hey, I'm Stasy. You're currently at the planet Mars!\nThroughout the last 100 years we've been improving transport to and from Mars.\nThis suite you're currently wearing helps against the radiation!", "Just talk with one of the inhabitants"]
        },
        1: {
            item: {
                id: 1
